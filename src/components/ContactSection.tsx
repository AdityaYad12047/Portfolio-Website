...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/aditya.12047@gmail.com", {
        method: "POST",
        headers: {
            ...
            <SlideInLeft delay={0.2}>
              <div className="card-dark p-8">
                ...
                <div className="flex gap-4">
                  <a
                    href="https://github.com/AdityaYad12047"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/aditya-y-7644961aa/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 px-6 py-3 rounded-full border border-border hover:border-primary hover:text-primary transition-all hover:scale-105 hover:shadow-lg"
                  >
